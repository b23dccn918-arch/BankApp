...
public class TransactionModel {
    ...
    public TransactionModel(long transactionId, int fromUserId, Integer toUserId, String type,
                       BigDecimal amount, String description, LocalDateTime createdAt, String status) {
